 ...
 * 在此写用途
 *
 * @FileName: me.khrystal.use_recycler_view_pager.SixthActivity.java
 * @author: kHRYSTAL
 * @email: 723526676@qq.com
 * @date: 2016-03-01 10:27
 */
public class SixthActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerViewPager = (LoopRecyclerViewPager) findViewById(R.id.pager);
        tabs = (TabLayout) findViewById(R.id.tab_title);
        ...
        LayoutAdapter adapter = new LayoutAdapter(this, mRecyclerViewPager);
