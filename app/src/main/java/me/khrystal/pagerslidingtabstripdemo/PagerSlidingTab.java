 ...
 * 在此写用途
 *
 * @FileName: me.khrystal.pagerslidingtabstripdemo.PagerSlidingTab.java
 * @author: kHRYSTAL
 * @email: 723526676@qq.com
 * @date: 2016-02-18 11:29
 */
...
public class PagerSlidingTab extends HorizontalScrollView {
    ...
    private void addTab(final int position, View tab, View tab2) {
        ...
        if (position==0){
            tab.setPadding(width/3+20, 0, tabPadding, 0);
            tab2.setPadding(width/3+20, 0, tabPadding, 0);
        }else if (position==tabCount-1) {
            tab.setPadding(tabPadding, 0, width/3, 0);
            tab2.setPadding(tabPadding, 0, width/3, 0);
        }else {
        ...
        framelayout.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                scrollToChildClick(position, 0);//滚动HorizontalScrollView
            }
        });
    ...
    private void scrollToChild(int position, int offset) {
        ...
        int newScrollX = tabsContainer.getChildAt(position).getLeft() + 0;
        ...
        if (newScrollX != lastScrollX) {
            ...
            int l = tabsContainer.getChildAt(position).getLeft() + 0;
    ...
    private void scrollToChildClick(int position, int offset) {
