 ...
 * 在此写用途
 *
 * @FileName: me.khrystal.custom_view_pager.RecyclingPagerAdapter.java
 * @author: kHRYSTAL
...
public abstract class RecyclingPagerAdapter extends PagerAdapter {
    ...
    private final RecyclerBin recycleBin;

    public RecyclingPagerAdapter() {
        this(new RecyclerBin());
    }

    RecyclingPagerAdapter(RecyclerBin recycleBin) {
